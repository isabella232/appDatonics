      ...
      return(
        <div className="card" style={{height: '360px'}}>
            ...
            <Row>
                    ...
                    <Col lg={1} className="text-right">{dataArr.length > 0 ? (<InlineIcon icon={informationOutline} onClick={visibleModal} style={{fontSize: '28px',
verticalAlign: '-moz-middle-with-baseline',color: '#ccc', cursor:'pointer'}}/>):(null)}</Col>
